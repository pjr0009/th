  ...
  module PaypalServiceInjector
    ...
    def build_paypal_payments
      events = Events.new({
          ...
          augment_transaction_details_with_paypal_info: -> (flow, details) {
            TransactionService::PaypalEvents.augment_transaction_details_with_paypal_info(flow, details)
          },
          ...
          payment_refunded: -> (flow, refund_info) {
            TransactionService::PaypalEvents.payment_refunded(refund_info)
          }
      })
